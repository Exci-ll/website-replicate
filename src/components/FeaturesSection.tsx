...
const FeaturesSection = () => {
  return (
<section className="py-12 px-4 md:px-6 bg-[#e8d4f8] mx-4 md:mx-6 rounded-xl border border-gray-900">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-10">
          {features.map((feature, index) => (
            <div key={index} className="bg-white rounded-lg p-5 card-hover border border-gray-900">
