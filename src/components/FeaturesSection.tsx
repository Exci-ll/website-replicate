...
const features = [
  ...
  },
  {
    ...
    iconBg: "bg-foreground text-white",
  },
  {
  ...
  return (
    <section className="py-12 px-4 md:px-6 bg-lime mx-4 md:mx-6 rounded-3xl">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-extrabold text-center mb-10 uppercase tracking-tight text-foreground">
          Use Tea Checker to
        </h2>
        ...
        <div className="flex items-center justify-center gap-3 bg-white rounded-full py-2.5 px-5 w-fit mx-auto">
          ...
          <span className="font-semibold text-sm text-foreground">274,436+ reviews</span>
        </div>

        {/* Avoid Red Flags */}
        <div className="mt-6 flex flex-col items-center">
          <h3 className="text-lg font-bold mb-3 text-foreground">Avoid Red Flags</h3>
