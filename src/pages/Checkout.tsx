...
const Checkout = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFE5E5] flex flex-col items-center">
      <div className="w-full max-w-md bg-white min-h-screen shadow-xl border-l border-r border-gray-900">
        ...
        <main className="px-4 py-5 space-y-5">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <span className="relative bg-[#FFE5E5] px-3 text-xs text-gray-500">
              Or pay with card
            </span>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={index} className="bg-[#FFE5E5] rounded-lg p-4 border border-gray-900">
