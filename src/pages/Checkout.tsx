  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center">
      ...
      <div className="w-full max-w-md bg-card min-h-screen shadow-xl">
        {/* Header */}
        <header className="flex items-center justify-between py-3 px-4 bg-card border-b border-border">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-lime rounded-lg flex items-center justify-center">
              <span className="text-lg">🍵</span>
            </div>
            <span className="font-bold text-foreground text-sm">tea checker</span>
          </div>
          <Button 
            variant="outline" 
            size="sm"
        ...
        <main className="px-4 py-5 space-y-5">
          {/* Results Header */}
          <div>
            <h1 className="text-xl font-bold">Results for {answers.name || "You"}</h1>
          ...
          <div className="bg-card rounded-2xl p-4 border border-border shadow-sm">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-sm">Tea Posts Found</span>
              </div>
            ...
            <div className="flex justify-end">
              <span className="text-xs bg-foreground text-card px-2 py-0.5 rounded-full">
          ...
          {/* Potential Posts */}
          <div>
            <h2 className="text-base font-semibold mb-3">Potential posts found</h2>
            <div className="flex gap-2 overflow-x-auto pb-2">
              {mockPosts.slice(0, 3).map((post) => (
                <div
                  key={post.id}
                  className="relative flex-shrink-0 w-36 bg-card rounded-xl p-3 border border-border overflow-hidden"
                >
                  <div className="blur-sm">
                    <div className="flex items-center gap-1 mb-1">
                      <span className="text-xs bg-red-100 text-red-600 px-1.5 py-0.5 rounded text-[10px] font-medium">
                        {post.emoji} {post.type}
                      </span>
                    </div>
                    <p className="text-[11px] text-muted-foreground line-clamp-3 leading-tight">{post.preview}</p>
                    <p className="text-[10px] text-muted-foreground mt-2">{post.timeAgo}</p>
                  </div>
          ...
          <div className="space-y-0">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-base font-semibold">Unlock your full Tea report</h2>
            </div>

            {/* Discount Timer - lime background */}
            <div className="bg-lime rounded-t-xl py-2.5 px-4 flex items-center justify-center gap-2">
            ...
            <div className="bg-card rounded-b-xl border border-t-0 border-border p-4">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="font-semibold">Full Tea Report</h3>
                ...
                <div className="text-right bg-lime/30 rounded-xl px-3 py-2">
                  ...
                  <p className="text-xs text-muted-foreground line-through">$1.20/day</p>
                </div>
              </div>

              {/* Amazon Pay - exact yellow */}
              <Button 
                className="w-full h-11 bg-[#FFD814] hover:bg-[#F7CA00] text-foreground rounded-lg mb-1 font-medium text-sm"
              ...
              <div className="space-y-2 mb-4">
                ...
                >
                  <span className="w-5 h-5 bg-[#FFB3C7] text-foreground rounded text-xs font-bold flex items-center justify-center">K</span>
              ...
              <Button 
                onClick={handlePayment}
                className="w-full h-12 rounded-lg bg-foreground text-card hover:bg-foreground/90 font-semibold text-sm flex items-center justify-center gap-2"
              >
                Pay & Get Report
              ...
              <div className="flex items-center justify-center gap-2 mt-3">
                <div className="bg-muted px-2 py-1 rounded text-[10px] font-bold text-blue-600">VISA</div>
                <div className="bg-muted px-2 py-1 rounded text-[10px] font-bold text-blue-800">AMEX</div>
                <div className="bg-muted px-2 py-1 rounded text-[10px] font-bold text-orange-600">MC</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-xl p-4 border border-border">
            <h2 className="text-sm font-semibold text-center mb-3">Trusted by 50,000+ guys</h2>
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <p className="text-xl font-bold text-lime-dark">94%</p>
                <p className="text-[10px] text-muted-foreground">Accuracy Rate</p>
              </div>
              <div>
                <p className="text-xl font-bold text-lime-dark">50K+</p>
                <p className="text-[10px] text-muted-foreground">Searches</p>
              </div>
              <div>
                <p className="text-xl font-bold text-lime-dark">4.8★</p>
          ...
          {/* Testimonials */}
          <div>
            <h2 className="text-base font-semibold mb-3">What guys are saying</h2>
